...
export default function LandPage() {
  ...
  useEffect(() => {
    ...
    // Land size filter
    filtered = filtered.filter(property => 
      property.landSize >= landSizeRange[0] && property.landSize <= landSizeRange[1]
    )
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
        ...
        <Select value={locationFilter} onValueChange={setLocationFilter}>
          ...
          <SelectContent>
            <SelectItem value="value">All locations</SelectItem>
      ...
      <div>
        <Label className="text-sm font-medium mb-2 block">
          Land Size: {landSizeRange[0]} - {landSizeRange[1]} acres
        </Label>
        <Slider
          value={landSizeRange}
